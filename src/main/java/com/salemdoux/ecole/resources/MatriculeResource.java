...
public class MatriculeResource {
	...
	public ResponseEntity<Void> update(@RequestBody Matricule obj, @PathVariable Integer id) throws ObjectNotFoundException{
		obj.setId(id);
	...
	public ResponseEntity<Page<MatriculeDTO>> findPage(
