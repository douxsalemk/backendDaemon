...
public class EmployeResource {
	...
	public ResponseEntity<Void> insert(@RequestBody Employe obj){
	...
	public ResponseEntity<Void> update(@RequestBody Employe obj, @PathVariable Integer id) throws ObjectNotFoundException{
		obj.setId(id);
	...
	public ResponseEntity<Page<EmployeDTO>> findPage(
