...
public class EleveResource {
	...
	public ResponseEntity<Void> insert(@RequestBody Eleve obj){
	...
	public ResponseEntity<Void> update(@RequestBody Eleve obj, @PathVariable Integer id) throws ObjectNotFoundException{
		obj.setId(id);
	...
	public ResponseEntity<Page<EleveDTO>> findPage(
