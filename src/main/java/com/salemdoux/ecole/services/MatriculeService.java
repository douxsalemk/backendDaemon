...
public class MatriculeService {
	...
	/*
	 * NÂO SE PODE ATUALIZAR A MATRICULA
	 * 
	 * public Matricule update(Matricule obj) throws ObjectNotFoundException {
	 * find(obj.getId()); return repo.save(obj); }
	 */
	
	/* NÂO SE PODE DELETATR UMA MATRICULA ISOLADAMENTE
	 * 
	 * public void delete(Integer id) throws ObjectNotFoundException { find(id); try
	 * { repo.deleteById(id); } catch (DataIntegrityViolationException e) { throw
	 * new
	 * DataIntegrityException("Não é possível deletar um endereço relationado a uma pessoa"
	 * );
	 * 
	 * } }
	 */
